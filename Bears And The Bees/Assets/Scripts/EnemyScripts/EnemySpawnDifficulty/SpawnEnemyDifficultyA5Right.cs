...
public class SpawnEnemyDifficultyA5Right : MonoBehaviour
{
    ...
    private void SpawnEnemy()
    {
        ...
        else if (getEnemyDifficulty == 2)
        {
            ...
            GameObject bee7 = Instantiate(basicBeeEnemy, position7, Quaternion.identity);
        ...
        else if (getEnemyDifficulty == 3)
        {
            ...
            GameObject bee8 = Instantiate(basicBeeEnemy, position8, Quaternion.identity);
            bee8.transform.parent = transform;

            Vector3 position9 = new Vector3(-38f, 0.5f, -123f);
            GameObject bee9 = Instantiate(basicBeeEnemy, position9, Quaternion.identity);
            ...
            GameObject sun4 = Instantiate(sunEnemy, positionSun4, Quaternion.identity);
